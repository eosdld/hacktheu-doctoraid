...
def load_models(path):
    tokenizer_path = 'https://drive.google.com/uc?export=download&id=1T6vD_a6ndnnBpi2nyLopWj-Y4_yBFTjZ'
    encoderCNN_checkpoint_path = 'https://drive.google.com/uc?export=download&id=1-6F7QObjzgx4QEixIqE2hGpQOyJyzYjw'
    encoderCNN_index_path = 'https://drive.google.com/uc?export=download&id=1-6W0rTPKvCjGOBLs9DbKMzC21jPQ2F4I'
    encoderCNN_data12_path = 'https://drive.google.com/uc?export=download&id=1-8UtELTnE044BNEskuhwCVsBVPEfdT2-'
    encoderCNN_data02_path = 'https://drive.google.com/uc?export=download&id=1-8wht_t_RDwZI9cg8BAiOi1LaxUnJKbs'
    decoderRNN_checkpoint_path = 'https://drive.google.com/uc?export=download&id=1-BIvMRqZuwU_WWz5K5Ib2WSPdv93Fvpq'
    decoderRNN_index_path = 'https://drive.google.com/uc?export=download&id=1-CFN6AV7cksZ3TkjR1ayBKXmZ_tqngfK'
    decoderRNN_data12_path = 'https://drive.google.com/uc?export=download&id=1--SfzCQnFBlUmnvAIZt4PyNnZokH_miA'
    decoderRNN_data02_path = 'https://drive.google.com/uc?export=download&id=1-62sGr4RNwEvcb-EzXEY1aJF07WbmvTa'
